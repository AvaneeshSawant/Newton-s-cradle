...
function setup() {
	...
	roof = new Roof(400, 150, 750, 20)

	bobObject1 = new Bob(280, 350, 30)
	bobObject2 = new Bob(340, 350, 30)
	bobObject3 = new Bob(400, 350, 30)
	bobObject4 = new Bob(460, 350, 30)
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		Matter.Body.applyForce(bobObject1.body, bobObject1.body.position, {x:-75, y:85})
	}
}
